export const siteDataEn = {
  ...
  navCta: "LET'S GO",
  hero: {
    eyebrow: "NEIGHBORHOOD CAFÉ · POPOTLA",
    title: ["COME FOR", "THE COFFEE.", "STAY FOR", "THE MOMENT."],
    intro: "Great coffee, something delicious, and a place to share, work, or simply enjoy your time. Welcome to KALLISTA.",
  ...
  menu: {
    ...
    items: [
      ...
      { number: "02", name: "KALLISTA ICED COFFEE", detail: "High-altitude coffee · orange", price: "$68", className: "coffee" },
  ...
  place: {
    ...
    body: "Come to work, share something delicious, meet up with friends, or take a break. KALLISTA wants to become the place you always feel like coming back to.",
    origin: "KALLISTA comes from Kallisto: the most beautiful. To us, beauty lives in the moments we share.",
    perks: [
  ...
  events: {
    kicker: "WHERE THE COMMUNITY MEETS", title: ["EVENTS AT", "KALLISTA"], status: "COMING SOON", shortStatus: "SOON",
